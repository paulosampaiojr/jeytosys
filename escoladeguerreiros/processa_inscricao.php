...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($count > 0) {
        ...
        if ($result_last_id) {
            ...
            $sql_insert = "INSERT INTO inscricoes (nome_completo, email, telefone, sexo, geracao_id, nome_lider, contato_lider, dia_escola, codigo_matricula, horario_inscricao, tipo_formulario_fk)
                           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)";
...
<body>
    <div class="confirmation-container">
        ...
        <p>Inscrição realizada as: <span class="highlight"><?php echo $horario_inscricao; ?></span></p>
