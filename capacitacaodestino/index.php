...
<body>
    <div class="form-container">
        <div class="container">
            <img src="css/capdestino.png" alt="Imagem centralizada" width="100%">
        </div>
        ...
        <form action="processa_inscricao.php" method="POST" onsubmit="return validarFormulario(event)">
            ...
            <label for="termo_inscricao" class="checkbox-container">
                <input type="checkbox" id="termo_inscricao" name="termo_inscricao" value="1" required>
                <span>Declaro que já que participei do ENCONTRO COM DEUS / UNIVERSIDADE DA VIDA.</span>
            </label>
