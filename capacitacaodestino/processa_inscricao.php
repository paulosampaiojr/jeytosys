...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($count > 0) {
        ...
        if ($result_last_id) {
            ...
            $codigo_matricula = "CAP-DESTINO-" . str_pad($last_id, 3, '0', STR_PAD_LEFT); // Ex: ECI-001
...
<body>
    <div class="confirmation-container">
        <div class="container">
            <img src="css/capdestino.png" alt="Imagem centralizada" width="50%">
        </div>
        ...
        <p>
            ...
            <span>Declaro que já que participei do ENCONTRO COM DEUS / UNIVERSIDADE DA VIDA.</p>
